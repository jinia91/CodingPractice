...
public class no9426_2 {
	...
	static int biSearch(int s, int e, int target) {
	...
	public static void main(String[] args) throws IOException {
		...
		LinkedList<Integer> deleteQ = new LinkedList<>();
		...
		for (int i = 0; i < N; i++) {
			...
			if (i == K - 1) {
				...
				long target = biSearch(0, 1000000, (K + 1) / 2);
